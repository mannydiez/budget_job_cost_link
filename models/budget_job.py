...
class job_costing_planned_amount_comparison(models.Model):
	...
	def create(self,vals):
		...
		log.critical('res.job_cost_line_ids = {}'.format(res.job_cost_line_ids))
		log.critical('res.job_cost_line_ids.total_cost = {}'.format(res.job_cost_line_ids[0].total_cost))
		log.critical('res.job_labour_line_ids = {}'.format(res.job_labour_line_ids))
		log.critical('res.job_subcon_line_ids = {}'.format(res.job_subcon_line_ids))
		log.critical('res.job_overhead_line_ids = {}'.format(res.job_overhead_line_ids))
		list_of_objects = []
